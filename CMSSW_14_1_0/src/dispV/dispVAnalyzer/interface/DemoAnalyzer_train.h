#ifndef DemoAnalyzer_train_h
#define DemoAnalyzer_train_h
...
class DemoAnalyzer_train : public edm::stream::EDAnalyzer<edm::GlobalCache<ONNXRuntime>> {
   public:
      explicit DemoAnalyzer_train (const edm::ParameterSet&, const ONNXRuntime *);
      ~DemoAnalyzer_train();
