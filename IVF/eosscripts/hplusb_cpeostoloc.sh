...
do
	...
	do
		...
		EOS_DIR=$(xrdfsls /store/user/nvenkata/BTV/hb_${era}_HZZ4l_${fs}_2406/HPlusBottom_${fs}_MuRFScaleDynX0p50_HToZZTo4L_M125_TuneCP5_13TeV_amcatnlo_JHUGenV7011_pythia8/MC_hplusb${fs}_${era}_HZZ4l_2406)/0000
		#EOS_DIR=$(xrdfsls /store/user/nvenkata/BTV/hc_${era}_HZZ4l_${fs}_2406/HPlusCharm_${fs}_MuRFScaleDynX0p50_HToZZTo4L_M125_TuneCP5_13TeV_amcatnlo_JHUGenV7011_pythia8/MC_hplusc${fs}_${era}_HZZ4l_2406)/0000
		
		
		# Local directory to copy TO
		LOCAL_DIR="/uscmst1b_scratch/lpc1/3DayLifetime/nvenkata/hb/"
